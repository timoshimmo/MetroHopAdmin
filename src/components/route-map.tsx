                    ...
                    (route.stops || []).map((stop, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill={route.color} stroke="#fff" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
